<template>
  <div class="interim-community">
    <FHHeader
      :backTitle="$route.meta.backTitle || 'Новости'"
      :rootRoute="$route.meta.backRoute || 'community'"
    ...
    >
      <img src="assets/hero/community.webp" slot="background" alt="" />
      <h1 center>{{ $route.meta.hero }}</h1>
    </tc-hero>
    <FHRouter />
  </div>
</template>
