    ...
    <div max-width>
      <FHAppear>
        <div v-if="$store.getters.telegramChat">
          <h3>Telegram</h3>
          <p>
            Вы успешно связали свою учетную запись с Telegram. Вы можете удалить
            эту ссылку в любое время.
          </p>
          <br />
          <tc-button
            tfbackground="error"
        ...
        <div v-else>
          <div center>
            Свяжите свою учетную запись Telegram с учетной записью FitnessHub,
            чтобы использовать все возможности FitnessHub. Получайте автономные
            сообщения от друзей и многое другое!
          </div>
          <br />
          <h3 center>Учетные записи</h3>
          <ol>
            <li>Установите Telegram</li>
            <li>
              Дайте нашему боту любой
              <tc-link href="http://t.me/FitnessHubAppBot" tfcolor="success">
                Отправить сообщение
              </tc-link>
            </li>
            <li>
              Дождитесь его ответа и введите полученный ниже код
            </li>
          </ol>
          <br />
