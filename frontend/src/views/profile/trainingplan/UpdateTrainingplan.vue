  ...
  <div class="view-update-trainingplan">
    <div content max-width>
      ...
      <template v-if="currentWorkout">
        <tc-divider :dark="true" />
        <h3 center>Текущая тренировка</h3>
        <div class="workout-exercise-preview">
      ...
      <tc-segments v-model="segment" :dark="true">
        <tc-segment-item title="Тренировка" />
        <tc-segment-item title="Упражнение" />
      </tc-segments>
          ...
          <tl-flow horizontal="space-between">
            ...
            <form @submit.prevent="submit">
              <tc-input
                ...
                :frosted="true"
                :dark="true"
                placeholder="Поисковое упражнение"
                @input="submit"
              />
            </form>
          </tl-flow>
