<template>
  <div class="view-add-friend">
    <div content max-width>
      <FHHeader title="Добавить друга">
        <FHFullScreenCloser @click="$cFS('friends')" />
      </FHHeader>

      <br />
      <h1 center>Добавить друзей</h1>

      <tl-flow>
        <img src="assets/team.svg" height="100" alt="" />
      </tl-flow>
      <p center>
        Добавляйте своих друзей, и пусть они вдохновляют и мотивируют вас,
        обмениваясь новостями, планами тренировок, рецептами и опытом.
      </p>
      <br />
