    ...
    <div max-width>
      ...
      <FHAppear>
        <div v-if="trendingExercises && trendingExercises.length > 0">
          <FHHeading title="Упражнения" subtitle="Популярные" />
          <FHCarousel>
            <FHExercisePreview
      ...
      <FHAppear>
        <div v-if="latestExercises && latestExercises.length > 0">
          <FHHeading title="Упражнения" subtitle="Последние" />
          <FHCarousel>
            <FHExercisePreview
      ...
      <FHAppear>
        <div v-if="latestWorkouts && latestWorkouts.length > 0">
          <FHHeading title="Тренировки" subtitle="Текущий" />
          <FHCarousel>
            <FHWorkoutPreview
      ...
      <FHAppear>
        <div v-if="muscles && muscles.length > 0">
          <FHHeading subtitle="затронутая тема" title="Мышцы" />
          <FHVarList>
            <FHVarListItem
              v-for="m in muscles"
              :key="m._id"
