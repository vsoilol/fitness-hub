  ...
  <div class="view-nutrition" content>
    <div max-width>
      <tl-grid minWidth="150" gap="10">
        <FHButton icon="lens" title="Рецепт" routeName="search-recipe" />
        <FHButton icon="book-filled" title="Вики" routeName="nutrition-wiki" />
      </tl-grid>
      ...
      <FHAppear>
        <div v-if="categories && categories.length > 0">
          <FHHeading subtitle="рецепт" title="Категории" />
          <FHCarousel>
            <FHCategoryPreview
      ...
      <FHAppear>
        <div v-if="belovedRecipes && belovedRecipes.length > 0">
          <FHHeading title="Рецепты" subtitle="Популярные" />
          <FHCarousel>
            <FHRecipePreview
      ...
      <FHAppear>
        <div v-if="latestRecipes && latestRecipes.length > 0">
          <FHHeading title="Рецепты" subtitle="Последние" />
          <FHCarousel>
            <FHRecipePreview
      ...
      <FHAppear>
        <div v-if="nutritionplans && nutritionplans.length > 0">
          <FHHeading subtitle="сбалансированный" title="Планы питания" />
          <FHCarousel>
