<template>
  <div class="view-nutritionplan">
    <FHHeader :title="plan ? plan.title : 'План питания'" :trigger="250">
      ...
      <tc-hero :dark="true">
        ...
        <div class="hero-container" v-if="plan">
          ...
          <div class="workout-information" center>
            ...
            <div class="updated">обновлено {{ tsUpdated }}</div>
          </div>
        </div>
      </tc-hero>
    </FHSwipeable>
        ...
        <div class="grid">
          ...
          <tl-flow flow="column" v-for="d in Object.keys(days)" :key="'s' + d">
            <template v-if="(plan[d].snacks || []).length > 0">
              <div class="snacks-title">Закуски</div>
              <div
                class="recipe"
